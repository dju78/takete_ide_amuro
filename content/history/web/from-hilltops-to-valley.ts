export const BOOK_SOURCE_TITLE =
...
export const BOOK_EDUCATION_MILESTONES = [
  ...
  {
    period: "1953",
    title: "Native Authority School",
    detail:
      "The S.I.M initiated the re-establishment of the school and the Yagba Native Authority took over its running as Native Authority School, Takete-Ide.",
  },
  {
    period: "1958–1963",
...
export const BOOK_HEALTH_MILESTONES = [
  {
    period: "1943 era",
  ...
  },
  {
    ...
    title: "ECWA clinic commissioned",
    detail:
      "A clinic established by ECWA Church was commissioned along Aiyedayo Road to serve Takete-Ide, Ayede, Ayedayo and surrounding communities.",
  },
] as const;
...
export const BOOK_DEVELOPMENT_INTERVENTIONS = [
  ...
  },
  {
    ...
    title: "Postal agency",
    detail:
      "A postal agency was established when letter writing, postal orders and money orders were important channels of communication and remittance.",
  },
  {
    period: "2007/08–2012",
...
export const BOOK_PACESETTERS = [
  ["First church", "Sudan Interior Mission (S.I.M), 1919; later ECWA"],
  ["First pastor", "Late Pa. Agbale"],
  ["First choir", "Established 29 December 1930"],
  ["First choirmaster", "Late Pa. Ezra Afolabi"],
  ["First bricklayer", "Pa Peter Olowodara"],
  ["First literate person", "Pa Peter Olowodara"],
  ["First school", "S.I.M School, Takete-Ide, established 1943"],
  ["First dispenser / community health worker", "Pa S. B. Makanjuola"],
  ["First person recorded as travelling abroad", "Late Pa. Eseyin Ernest Lazarus, Birmingham, United Kingdom, circa 1964"],
  ["First vehicle owner", "Late Pa. Paul Olayemi, about 1965"],
  ["First church wedding", "Late Pa. and Mrs Bolarin Olukomogbon, 1971"],
  ["First graduate", "Titus Ayeni, Agricultural Science, Ahmadu Bello University, 1966"],
  ["First female graduate", "Mrs Ebun Obaro, English Education, University of Ilorin, 1982"],
  ["First PhD", "Dr David Atte, Geography, 1979"],
  ["First professor", "Olu Atte, 1995"],
  ["First nurse", "Mrs Omoboni Mokunolu"],
  ["First banker", "Pa Bolarin Olukomogbon"],
  ["First journalist", "Mr Dickson Adeyanju"],
  ["First chartered accountant", "Mr Henry Abimbola"],
  ["First commissioner", "Dr David Atte, Kwara State, 1983"],
  ["First House of Assembly member", "Chief Eric Olorunjuwon Fiki"],
  ["First Local Government Vice-Chairman", "Chief Emmanuel Elesho"],
  ["Pioneer principal of GDSS Takete-Ide", "Chief Kayode Fanwo"],
] as const;

export const BOOK_COMMUNITY_ORGANISATIONS = [
  {
