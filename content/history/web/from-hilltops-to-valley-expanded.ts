...
export const BOOK_CHAPTERS = [
  {
    number: 1,
    title: "Clean State of Nature",
    summary:
      "Introduces Takete-Idera, its location within Amuro, the wider Yagba and Okun setting, indigenous religion, masquerade traditions, music, games and everyday community life.",
  },
  {
    number: 2,
    title: "Takete-Ide: Story of a People’s Search for Peace",
    summary:
      "Traces the movement from Amuro-Odo through Igbo Ide, Ilu-Oke, Okeata and surrounding uplands to the present settlement around 1926, including Agbagba Ide and the naming of Takete-Idera.",
  },
  {
    number: 3,
    title: "Religion",
    summary:
      "Records the indigenous religious worldview of Takete-Ide, the Agado and Oliwo groupings, Egungun traditions, women’s religious traditions, music and associated cultural practices.",
  },
  {
    number: 4,
    title: "The Birth of Christianity",
    summary:
      "Provides regional background to the Sudan Interior Mission and the missionary movement that eventually reached Yagbaland and Takete-Ide.",
  },
  {
    number: 5,
  ...
  {
    number: 6,
    title: "Further Migration: Takete-Tedo, Okegada, Amuro",
    summary:
      "Records the later movement to Takete-Tedo at Okegada from 1949 onward and the communal labour through which the new settlement grew.",
  },
  {
    number: 7,
    title: "Modern Civilization in Takete-Ide",
    summary:
      "Covers literacy, primary and secondary education, early healthcare, the first dispenser, nurses and midwives, and later clinic development.",
  },
  {
    number: 8,
    title: "Growth of the Faith",
    summary:
      "Records the growth of non-Baptist Christian congregations, the development of multiple places of worship and the formation of the Takete-Ide ECWA LCC.",
  },
  {
    number: 9,
    title: "The Traditional Council of Takete-Ide",
    summary:
      "Describes the functions and hierarchy of the Traditional Council, ward rotation of the Olu’de stool and categories and procedures of chieftaincy.",
  },
  {
    number: 10,
    title: "Pacesetters: A Chapter of Firsts",
    summary:
      "Lists people and institutions recorded as firsts in education, professions, public service, transport, housing, health and community life.",
  },
  {
    number: 11,
    title: "Government Interventions in Takete-Ide",
    summary:
      "Records public infrastructure and development interventions in roads, irrigation, education, postal services, healthcare, ICT, water and agriculture.",
  },
  {
    number: 12,
    title: "Festivals in Takete-Ide",
    summary:
      "Documents Christmas and New Year customs, Easter, New Yam, Egungun/Epa, Ogun, Imole and Takete-Ide Day.",
  },
  {
    number: 13,
    title: "Weaving the Threads of Takete-Ide’s Communal Soul",
    summary:
      "Highlights TIPU, Jet Club, Owe, TISU and Egbe Ode as associations that sustain civic life, youth development, communal farming, education and community security.",
  },
] as const;
...
export const BOOK_LAND_PROFILE = {
  ...
  boundaries: [
    "Otafun Amuro to the east",
    "Aiyedayo Amuro to the south",
    "Aiyede Amuro to the west",
  ],
...
export const BOOK_TAKETE_TEDO = {
  ...
  firstRecordedNeighbours: [
    "Overseer Cornelius Maiye — Takete-Tedo",
    "Pa Malachy Iselewo — Aiyede-Tedo",
    "Chief Elewa Agunbiade — Okagi-Tedo axis",
  ],
  recordedSettlers: [
    "Moses Atteh",
    "Pa Malaki Anjorin",
...
export const BOOK_COUNCIL_FUNCTIONS = [
  "Preserve, promote and transmit the customs, traditions, values and customary laws of Takete-Ide.",
  "Protect and promote the community’s cultural heritage, historical identity and indigenous institutions.",
  "Promote peace, unity, harmony and social cohesion within the community.",
  "Mediate and resolve disputes in accordance with customary practice and principles of natural justice.",
  "Represent the traditional identity and cultural interests of Takete-Ide before recognised community, traditional and governmental forums.",
  "Coordinate and preserve traditional, cultural, ceremonial and customary affairs.",
] as const;

export const BOOK_COUNCIL_HIERARCHY = [
  {
    level: "The Olu’de",
    description: "Paramount traditional ruler of Takete-Ide and head of the Traditional Council.",
  },
  {
    level: "The Otunba",
...
export const BOOK_WARDS = ["Ok’Ako", "Ok’Adan", "Odo-Takete"] as const;

export const BOOK_CHIEFTAINCY_CATEGORIES = [
  {
    name: "Oye Ilu",
    description:
  ...
  },
  {
    name: "Oye Adugbo",
    description:
      "Ward-associated titles that are carefully retained within the ward as the title evolves across generations.",
  },
  {
    name: "Oye Idile",
    description:
      "Family-associated titles, some of which remain within a family or direct lineage for several generations where suitable successors are available.",
  },
  {
    name: "Oye Idanilola",
    description:
...
export const BOOK_CHIEFTAINCY_PROCESS = [
...
export const BOOK_1943_PIONEER_PUPILS = [
  "Late John Ipinjolu",
  "Late Ernest Lazarus",
  "Late Emmanuel Amora",
  "Late Lot Omoniyi",
...
export const BOOK_1953_PIONEER_PUPILS = [
  "Late Joshua Adesoji Olukomogbon — head boy",
  "Late Bolarin Olukomogbon",
  "Late Mathew Medebise",
  "Late William Omoniwa",
  "Pa Enock Soje",
  "Pa Sunday Aguda",
  "Late Bosede Bello (Ejiko)",
  "Late Mini Thomas",
  "Mrs Alice Eseyin (EB)",
  "Late Prof. Adegoke",
  "Late Johnson Ogunlabi",
  "Mrs Margret Omoboni Mokuolu",
] as const;

export const BOOK_1963_FIRST_GRADUATES = [
  "Engineer Reuben Ebilakun",
  "Dr Oluwayomi David Atte",
  "Director Edwin Olu Aguda",
  "Late Captain Noah Eseyin",
  "Late Major Ayo Thomas",
  "Ebun Moses",
  "Late Rebeccah Fasemami (Ogbondeminu)",
  "Late Daniel Kayode Mose",
] as const;
...
export const BOOK_MUSIC_TRADITIONS = [
  {
    name: "Paalongo",
    description:
      "An older musical group remembered for performances at important ceremonies and rehearsals.",
  },
  {
    name: "Ogbeele",
    description:
      "An older musical group recorded alongside Paalongo as part of the community’s ceremonial entertainment tradition.",
  },
] as const;

export const BOOK_TRADITIONAL_INSTRUMENTS = ["Oye", "Agogo", "Akutu", "Elu", "Aje"] as const;

export const BOOK_CHILDHOOD_GAMES = [
  { name: "Igidi", note: "Wrestling" },
  { name: "Ese jiju", note: "Boxing" },
...
export const BOOK_ADDITIONAL_PACESETTERS = [
  ...
  ["First college principal", "Late Pa Sunday Funsho Aguda"],
  ["First Director-General in the civil service", "Chief William Omoniwa"],
  ["First aide-de-camp to a state chief executive", "Capt. Gbenga Olayemi, 1998–99"],
] as const;

export const BOOK_FESTIVAL_DETAILS = [
  {
...
export const BOOK_COMMUNITY_ORGANISATION_DETAILS = [
  {
