...
export const CHURCHES_DIRECTORY: ChurchDirectoryItem[] = [
  ...
  },
  {
    ...
    historyStatus: "Community Church",
    established: null,
    establishedQualifier: null,
    featured: false,
    sourceStatus: "community_tradition",
    hasFullProfile: false,
  },
  {
    ...
    imageCaption: null,
    summary:
      "An established Christian congregation serving the Takete-Ide community.",
    historyStatus: "Community Church",
    established: null,
    establishedQualifier: null,
    featured: false,
  ...
  },
  {
    ...
    imageCaption: null,
    summary:
      "An established place of worship serving the Takete-Ide community.",
    historyStatus: "Community Church",
    established: null,
    establishedQualifier: null,
    featured: false,
  ...
  },
  {
    ...
    summary:
      "ECWA Christian congregation serving the Takete-Ide community, established as a distinct congregation from First ECWA Church.",
    historyStatus: "Community Church",
    established: null,
    establishedQualifier: null,
    featured: false,
  ...
  },
  {
    ...
    summary:
      "A Christian parish serving the Takete-Ide community.",
    historyStatus: "Community Church",
    established: null,
    establishedQualifier: null,
    featured: true,
  ...
  },
  {
    ...
    summary:
      "An established place of Christian worship in Takete-Ide, featuring a historic building structure of mud and timber construction.",
    historyStatus: "Community Church",
    established: null,
    establishedQualifier: null,
    featured: true,
  ...
  },
  {
    ...
    imageCaption: null,
    summary:
      "Christian congregation serving the Takete-Ide community.",
    historyStatus: "Community Church",
    established: null,
    establishedQualifier: null,
    featured: false,
  ...
  },
  {
    ...
    imageCaption: null,
    summary:
      "An established Christian congregation serving the Takete-Ide community, distinct from The Apostolic Church assembly.",
    historyStatus: "Community Church",
    established: null,
    establishedQualifier: null,
    featured: false,
  ...
  },
  {
    ...
    imageCaption: null,
    summary:
      "A Christian place of worship serving the Takete-Ide community.",
    historyStatus: "Community Church",
    established: null,
    establishedQualifier: null,
    featured: false,
  ...
  },
  {
    ...
    imageCaption: null,
    summary:
      "A Christian congregation in Takete-Ide.",
    historyStatus: "Community Church",
    established: null,
    establishedQualifier: null,
    featured: false,
  ...
  },
  {
    ...
    imageCaption: null,
    summary:
      "A Baptist congregation serving the Takete-Ide community.",
    historyStatus: "Community Church",
    established: null,
    establishedQualifier: null,
    featured: false,
