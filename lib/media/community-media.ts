...
export const communityMedia: CommunityMediaItem[] = [
  ...
  },
  {
    ...
    description: "Government Day Secondary School, Takete-Ide, secondary educational institution serving students in the community.",
    altText: "Government Day Secondary School classroom buildings and compound in Takete-Ide",
    category: "Education",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
