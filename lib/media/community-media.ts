...
export const communityMedia: CommunityMediaItem[] = [
  ...
  },
  {
    ...
    title: "Igboruku",
    description: "Igboruku, one of the prominent natural landmarks associated with the Takete-Ide community.",
    altText: "Igboruku river and rocky water landmark in Takete-Ide",
    category: "Nature",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  },
  {
    ...
    title: "Omi Pandara",
    description: "Omi Pandara, a natural water spring and cherished community landmark in Takete-Ide.",
    altText: "Omi Pandara natural water landmark in Takete-Ide",
    category: "Nature",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  },
  {
    ...
    title: "Oko Loke",
    description:
      "Oko Loke — a natural and community landmark in Takete-Ide, remembered within the community in connection with traditional local activities.",
    altText: "Video of the rocky stream and natural waters at Oko Loke in Takete-Ide",
    category: "Nature",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  },
  {
    ...
    mediaType: "image",
    src: "/images/takete-ide/places/the-apostolic-church-takete-ide.jpg",
    title: "The Apostolic Church, Takete-Ide",
    description: "The Apostolic Church, Takete-Ide church building and grounds.",
    altText: "The Apostolic Church building in Takete-Ide",
    category: "Places of Worship",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  // ── Education ───────────────────────────────────────────────────────────
  {
    ...
    description: "Takete-Ide Primary School, one of the community's educational institutions.",
    altText: "Takete-Ide Primary School building and compound in Takete-Ide",
    category: "Education",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  {
    id: "universal-basic-education-takete-ide",
    mediaType: "image",
    src: "/images/takete-ide/places/universal-basic-education-takete-ide.jpg",
    title: "Universal Basic Education, Takete-Ide",
    description: "Universal Basic Education, Takete-Ide classroom facilities supporting basic education.",
    altText: "Universal Basic Education classroom buildings and compound in Takete-Ide",
    category: "Education",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  {
    id: "takete-ide-ncc-computer-centre",
    mediaType: "image",
    src: "/images/takete-ide/places/takete-ide-ncc-computer-centre.png",
    title: "Takete-Ide NCC Computer Centre",
    description:
      "Takete-Ide NCC Computer Centre, representing local access to digital and technology facilities.",
    altText: "Takete-Ide NCC Computer Centre building with solar panels",
    category: "Education",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  },
  {
    ...
    description: "Government Day Secondary School, Takete-Ide.",
    altText: "Government Day Secondary School, Takete-Ide campus",
    category: "Education",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  {
    id: "otegun-orisa-deity-house",
    mediaType: "image",
    src: "/images/takete-ide/places/otegun-orisa-deity-house.jpg",
    title: "Otegun – Orisa Deity House",
    description: "Otegun, a traditional Orisa deity house in Takete-Ide.",
    altText: "Otegun traditional Orisa deity house in Takete-Ide",
    category: "Culture & Events",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  },
  {
    ...
    mediaType: "image",
    src: "/images/takete-ide/places/takete-ide-town-hall.jpg",
    title: "Takete-Ide Town Hall",
    description: "Takete-Ide Town Hall, a community facility for civic and community activities.",
    altText: "Takete-Ide Town Hall building with light-green roof and entrance pillars",
    category: "Landmarks",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  {
    id: "takete-ide-area-court",
    mediaType: "image",
    src: "/images/takete-ide/places/takete-ide-area-court.jpg",
    title: "Area Court, Takete-Ide",
    description: "Area Court, Takete-Ide building serving the community in Mopamuro Local Government Area.",
    altText: "Area Court building in Takete-Ide",
    category: "Landmarks",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  {
    id: "takete-ide-local-government-facility",
    mediaType: "image",
    src: "/images/takete-ide/places/takete-ide-local-government-facility.jpg",
    title: "Takete-Ide Local Government Facility",
    description: "Takete-Ide Local Government facility serving the community in Mopamuro LGA.",
    altText: "Takete-Ide Local Government facility building",
    category: "Landmarks",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: false,
    published: true,
  ...
  {
    id: "takete-ide-police-station",
    mediaType: "image",
    src: "/images/takete-ide/places/takete-ide-police-station.jpg",
    title: "Takete-Ide Police Station",
    description: "Takete-Ide Police Station facility serving the community.",
    altText: "The Nigeria Police Station building in Takete-Ide",
    category: "Landmarks",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  {
    id: "takete-ide-civil-defence-office",
    mediaType: "image",
    src: "/images/takete-ide/places/takete-ide-civil-defence-office.jpg",
    title: "Takete-Ide Civil Defence Office",
    description: "Takete-Ide Civil Defence Office serving the community.",
    altText: "The Civil Defence office building in Takete-Ide",
    category: "Landmarks",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
    verificationStatus: "community-record",
    source: "Community-supplied photograph; building emblem identifies the facility",
  },
  {
    id: "takete-ide-primary-health-centre",
    mediaType: "image",
    src: "/images/takete-ide/places/takete-ide-primary-health-centre.jpg",
    title: "Takete-Ide Primary Health Centre",
    description: "The Primary Health Centre serving residents of Takete-Ide and the surrounding community.",
    altText: "Takete-Ide Primary Health Centre building in Takete-Ide",
    category: "Development",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
  ...
  {
    id: "takete-ide-old-health-centre",
    mediaType: "image",
    src: "/images/takete-ide/places/takete-ide-old-health-centre.jpg",
    title: "Old Health Centre",
    description: "The former health centre serving the Takete-Ide community.",
    altText: "The former Old Health Centre building in Takete-Ide",
    category: "Development",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: false,
    published: true,
  ...
  {
    id: "takete-ide-market",
    mediaType: "image",
    src: "/images/takete-ide/places/takete-ide-market.jpg",
    title: "Takete-Ide Market",
    description: "A view of Takete-Ide Market, supporting everyday trade and community economic activity.",
    altText: "Takete-Ide Market stalls and trading area in Takete-Ide",
  ...
  {
    id: "aiyedayo-junction",
    mediaType: "image",
    src: "/images/takete-ide/places/aiyedayo-junction.jpg",
    title: "Aiyedayo Junction",
    description: "A view of Aiyedayo Junction in Takete-Ide.",
    altText: "A view of Aiyedayo Junction in Takete-Ide",
    category: "Community Life",
    location: "Takete-Ide, Amuro, Kogi State",
    featured: true,
    published: true,
